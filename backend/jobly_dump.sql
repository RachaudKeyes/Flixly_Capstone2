...
--
-- Name: applications; Type: TABLE; Schema: public; Owner: rachaud
--
...
ALTER TABLE public.applications OWNER TO rachaud;

--
-- Name: companies; Type: TABLE; Schema: public; Owner: rachaud
--
...
ALTER TABLE public.companies OWNER TO rachaud;

--
-- Name: jobs; Type: TABLE; Schema: public; Owner: rachaud
--
...
ALTER TABLE public.jobs OWNER TO rachaud;

--
-- Name: jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: rachaud
--
...
ALTER TABLE public.jobs_id_seq OWNER TO rachaud;

--
-- Name: jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rachaud
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: rachaud
--
...
ALTER TABLE public.users OWNER TO rachaud;

--
-- Name: jobs id; Type: DEFAULT; Schema: public; Owner: rachaud
--
...
--
-- Data for Name: applications; Type: TABLE DATA; Schema: public; Owner: rachaud
--
...
--
-- Data for Name: companies; Type: TABLE DATA; Schema: public; Owner: rachaud
--
...
--
-- Data for Name: jobs; Type: TABLE DATA; Schema: public; Owner: rachaud
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: rachaud
--
...
testuser	$2b$12$imlTsCkIo7aqnJO8N1Jkx..2jPPzh79Sg1aycLyV77bgD6gYTovDq	Test	User	testemail@gmail.com	f
rarakeyes	$2b$12$HtNC8Yz3s.UZ2TlhC/ANH.t7a4/GLz4AqH0r4A7LMS9LbZynPFJ2q	Rachaud	Keyes	rachaudkeyes@gmail.com	f
\.


--
-- Name: jobs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: rachaud
--
...
--
-- Name: applications applications_pkey; Type: CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: companies companies_name_key; Type: CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: companies companies_pkey; Type: CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: jobs jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: applications applications_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: applications applications_username_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rachaud
--
...
--
-- Name: jobs jobs_company_handle_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rachaud
--
